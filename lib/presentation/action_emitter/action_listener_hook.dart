...
void useActionListener(
    void Function(CompositeSubscription compositeSubscription) listenCallback) {
...
class _ActionListenerHook extends Hook<void> {
  ...
  final void Function(CompositeSubscription compositeSubscription)
      listenCallback;
